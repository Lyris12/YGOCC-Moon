...
function s.initial_effect(c)
	...
	e4:SetOperation(s.drawactivate)
	c:RegisterEffect(e4)
end
function s.drawcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return c:IsReason(REASON_EFFECT) and rp~=tp and c:IsPreviousLocation(LOCATION_ONFIELD)
end

function s.drawactivate(e,tp,eg,ep,ev,re,r,rp)
