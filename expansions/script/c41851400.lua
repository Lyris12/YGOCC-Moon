...
function s.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(function(ef,tc) return 100*Duel.GetMatchingGroup(aux.AND(Card.IsFaceup,Card.IsSetCard),tc:GetControler(),LOCATION_MZONE,0,nil,0x106):GetSum(Card.GetLevel) end)
	e1:SetReset(RESET_EVENT+RESETS_STANDARD)
