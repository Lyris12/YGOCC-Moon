...
function cid.efilter(e,te)
	return te:IsActiveType(TYPE_SPELL) and te:GetOwnerPlayer()~=e:GetHandlerPlayer() or (te:IsActiveType(TYPE_MONSTER) and te:GetHandler():IsLocation(LOCATION_MZONE) and te:GetHandlerPlayer()~=e:GetHandlerPlayer() and c:IsAttribute(e:GetHandler():GetAttribute()))
end
