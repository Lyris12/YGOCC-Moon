...
function cid.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SendtoGrave(Duel.SelectMatchingCard(tp,cid.cfilter,tp,LOCATION_SZONE,0,1,1,c),REASON_COST)
end
...
function cid.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.SendtoHand(eg:Filter(cid.filter,nil,tp):Filter(Card.IsRelateToEffect,nil,e),nil,REASON_EFFECT)
end
