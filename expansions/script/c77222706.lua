...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--The equipped monster gains 500 ATK, also it can attack your opponent directly.
	...
	c:RegisterEffect(e4)
	--During your Main Phase: You can Special Summon 1 "Spindown Token" (Thunder/LIGHT/Level 1/0 ATK/1000 DEF).
...
function s.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsPlayerCanSpecialSummonMonster(tp,177222704,0,TYPES_TOKEN_MONSTER,0,1000,1,RACE_THUNDER,ATTRIBUTE_LIGHT) then
