...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--ATK
	c:UpdateATKField(200,nil,LOCATION_MZONE,0,aux.TargetBoolFunction(Card.IsRace,RACE_SPELLCASTER+RACE_WARRIOR))
	--splimit
...
function s.thfilter(c)
	return c:IsMonster() and c:IsRace(RACE_SPELLCASTER+RACE_WARRIOR) and c:IsAbleToHand()
end
...
function s.tdfilter(c)
	return c:IsMonster() and c:IsRace(RACE_SPELLCASTER+RACE_WARRIOR) and c:IsAbleToDeck()
end
