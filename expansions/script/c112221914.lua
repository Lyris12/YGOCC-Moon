...
function cid.initial_effect(c)
	...
	e2:SetOperation(function(e,tp,eg) local tc=eg:GetFirst() if tc and tc:IsCode(id-14) then Duel.SetChainLimitTillChainEnd(function(e,rp,p) return rp==p end) end end)
	c:RegisterEffect(e2)
	local e4=e2:Clone()
	...
	e5:SetOperation(function(e,tp,eg) if not eg:IsExists(aux.OR(Card.IsFacedown,aux.NOT(Card.IsCode)),1,nil,id-14) then Duel.SetChainLimitTillChainEnd(function(e,rp,p) return rp==p end) end end)
	c:RegisterEffect(e5)
