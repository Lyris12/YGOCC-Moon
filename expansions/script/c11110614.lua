--Ashiela, Lifeweaver's Fulfillment
--Ashiela, Adempimento della Vitatessitrice
--Scripted by: XGlitchy30

local s,id,o=GetID()
function s.initial_effect(c)
	--[[If this card is Normal Summoned, or Special Summoned by the effect of a "Lifeweaver" card:
	You can Set 1 "Lifeweaver" Trap directly from your Deck, but you cannot Special Summon monsters from your Extra Deck for the rest of this turn, except Time Leap Monsters.]]
