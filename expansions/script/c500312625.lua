...
function c500312625.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tg:GetCount()>0 then
		...
		Duel.SendtoGrave(mat2,REASON_EFFECT+REASON_RELEASE+REASON_MATERIAL+REASON_RITUAL)
		Duel.RaiseEvent(mat2,EVENT_RELEASE,e,REASON_EFFECT+REASON_MATERIAL+REASON_RITUAL,rp,tp,#mat2)
		Duel.BreakEffect()
