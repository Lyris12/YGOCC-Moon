...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:IsAbleToRemoveAsCost() and Duel.CheckReleaseGroup(REASON_COST,tp,Card.IsCode,1,nil,TOKEN_NEBULA) end
	local g=Duel.SelectReleaseGroup(REASON_COST,tp,Card.IsCode,1,1,nil,TOKEN_NEBULA)
