...
function c249000951.initial_effect(c)
	...
	e4:SetCountLimit(1,249000951)
	e4:SetTarget(c249000951.target2)
	e4:SetOperation(c249000951.operation2)
	c:RegisterEffect(e4)
end
...
function c249000951.thfilter(c)
	return c:IsSetCard(0x11FD) and c:IsAbleToHand()
end
function c249000951.target2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c249000951.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c249000951.operation2(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c249000951.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if g:GetCount()>0 then
