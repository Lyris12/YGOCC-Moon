...
function s.initial_effect(c)
	...
	e5:SetCondition(function() return c:IsPreviousLocation(LOCATION_MZONE) and (c:IsSummonType(SUMMON_TYPE_SPECIAL) or c:GetFlagEffect(id)>0) and c:IsReason(REASON_BATTLE+REASON_EFFECT) end)
	e5:SetTarget(s.sptg)
