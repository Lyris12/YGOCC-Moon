...
function cm.initial_effect(c)
	...
	e0:SetValue(function(e,se,sp,st) local sc=se:GetHandler() return aux.ritlimit(e,se,sp,st) and Senya.check_set_sayuri(sc) end)
	c:RegisterEffect(e0)
...
function cm.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetCustomOperationInfo(0,CATEGORY_SPSUMMON_RITUAL_MONSTER,nil,1,tp,LOCATION_DECK)
end
