...
function c1020090.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 
		...
		e:SetLabel(0)
		return Duel.CheckReleaseGroup(REASON_COST,tp,c1020090.cfilter,1,e:GetHandler(),e,tp) 
	end
	e:SetLabel(0)
	local g=Duel.SelectReleaseGroup(REASON_COST,tp,c1020090.cfilter,1,1,e:GetHandler(),e,tp)
