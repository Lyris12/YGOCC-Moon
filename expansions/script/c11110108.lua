...
function cm.costfilter(c,e,tp)
	return c:IsSetCard(0x2a7) and not c:IsCode(m) and Duel.GetMZoneCount(tp,c)>0 and Duel.IsExistingTarget(cm.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp,c:GetCode())
end
