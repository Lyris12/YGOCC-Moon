...
--Coded by Concordia
local cid,id=GetID()
function c68709380.initial_effect(c)
	--search
...
function cid.srfilter(c)
	return c:IsSetCard(0xf08) and c:IsType(TYPE_MONSTER) and not c:IsCode(68709380) and c:IsAbleToHand()
end
