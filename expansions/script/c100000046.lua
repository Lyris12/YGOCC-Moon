...
--Fay'lah, Culla della Foresta Tetra
...
function s.initial_effect(c)
	...
	--[[If this card is Transformed from "Leylah, Radiance of the Dreamy Forest": You can activate this effect; until the end of your opponent's next turn,
	...
	--[[During your opponent's turn, when your opponent activates a card or effect (Quick Effect): You can negate the activation, and if you do, banish that card.]]
