...
function s.xyzfilter(c,e,tp)
	return c:IsSetCard(0x721) and c:IsType(TYPE_XYZ) and c:IsRank(1) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_XYZ,tp,false,false)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.SpecialSummonStep(xyz,SUMMON_TYPE_SPECIAL,tp,tp,false,false,POS_FACEUP)
