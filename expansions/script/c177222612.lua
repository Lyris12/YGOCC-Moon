--Magicalia's Spell of the Sealing Light
local s,id=GetID()
function s.initial_effect(c)
	--If you control no monsters, or control a "Magicalia" monster: Target 1 face-up card your opponent controls; negate its effects until the end of this turn.
	...
	c:RegisterEffect(e1)
	--You can banish this card and 1 Spell or 1 Spellcaster monster from your GY; add 1 "Magicalia" card from your Deck to your hand, except "Magicalia's Spell of the Sealing Light".
