...
function s.initial_effect(c)
	...
	e2:SetTarget(aux.Target(Card.IsSpellTrapOnField,0,LOCATION_ONFIELD,1,1,nil,nil,nil,nil,nil,CATEGORY_DESTROY,aux.DamageInfo(1,500)))
...
function s.spfilter(c)
	return c:IsSetCard(0xfa6) and c:IsLevelAbove(4)
end
