...
function s.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Remove(Duel.SelectMatchingCard(tp,s.cfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,1,nil,tp),POS_FACEUP,REASON_COST)
end
...
function s.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SetOperationInfo(0,CATEGORY_TODECK,Duel.SelectTarget(tp,s.thfilter,tp,LOCATION_REMOVED,0,1,1,nil),1,0,0)
