--Carol, Lifeweaver's Bravery
--Carol, Coraggio della Vitatessitrice
--Scripted by: XGlitchy30

local s,id,o=GetID()
function s.initial_effect(c)
	--[[If this card is Normal Summoned, or Special Summoned by the effect of a "Lifeweaver" card: You can banish 1 "Lifeweaver" monster from your Deck,
	but you cannot Special Summon monsters from your Extra Deck for the rest of this turn, except Time Leap Monsters.]]
...
function s.rmfilter(c)
	return c:IsMonster() and c:IsSetCard(ARCHE_LIFEWEAVER) and c:IsAbleToRemove()
end
--E1
