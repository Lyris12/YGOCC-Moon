...
function c111765875.initial_effect(c)
	...
	e1:SetTarget(c111765875.thtg)
	e1:SetOperation(c111765875.thop)
	c:RegisterEffect(e1)
	--specialsummon
	...
	e2:SetTarget(c111765875.sptg2)
	e2:SetOperation(c111765875.spop2)
	c:RegisterEffect(e2)
end
--link materials
...
function c111765875.spop2(e,tp,eg,ep,ev,re,r,rp)
