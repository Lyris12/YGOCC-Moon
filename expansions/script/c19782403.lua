...
function cid.scfilter(c,tp)
	return c:IsSetCard(0xd7c) and (c:IsAbleToHand() or Duel.GetLocationCount(tp,LOCATION_SZONE)>0)
end
--target sc
...
function cid.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,cid.costfilter,tp,LOCATION_SZONE,0,1,2,nil)
...
function cid.pltg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectTarget(tp,cid.plfilter,tp,LOCATION_GRAVE,0,1,2,nil,e,tp)
end
--op plop 
