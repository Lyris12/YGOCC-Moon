...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	local e4=c:DriveEffect(0,aux.Stringid(id,0),nil,nil,nil,nil,aux.NOT(s.qcon),nil,s.ectg,s.ecop):Clone()
	e4:SetType(EFFECT_TYPE_QUICK_O)
	e4:SetCode(EVENT_FREE_CHAIN)
	e4:SetCondition(s.qcon)
	c:RegisterEffect(e4)
	local e5=c:DriveEffect(-18,1124,CATEGORY_DESTROY,nil,nil,nil,aux.NOT(s.qcon),nil,s.destg,s.desop):Clone()
	e5:SetType(EFFECT_TYPE_QUICK_O)
	e5:SetCode(EVENT_FREE_CHAIN)
	e5:SetCondition(s.qcon)
	c:RegisterEffect(e5)
	local e6=c:OverDriveEffect(c,1109,CATEGORY_SEARCH+CATEGORY_TOHAND,nil,nil,nil,aux.NOT(s.qcon),nil,s.thtg,s.thop)
