...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	local e4=c:DriveEffect(0,aux.Stringid(id,0),nil,nil,nil,nil,s.icon,nil,s.ectg,s.ecop):Clone()
	e4:SetType(EFFECT_TYPE_QUICK_O)
	e4:SetCode(EVENT_FREE_CHAIN)
	e4:SetCondition(s.qcon)
	c:RegisterEffect(e4)
	local e5=c:DriveEffect(18,1124,CATEGORY_DESTROY,nil,nil,nil,s.icon,nil,s.destg,s.desop):Clone()
