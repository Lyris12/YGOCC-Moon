--RUM－千死蛮巧
--Reason for modification: Generalized implementation of restrictions similar to the one of "Number C88: Gimmick Puppet Disaster Leo"
...
function c96142517.spfilter2(c,e,tp,rk,tg)
	if c.rum_limit and not c.rum_limit(tg,e,tp,c) then return false end
	return c96142517.spfilter(c,e,tp,rk)
end
