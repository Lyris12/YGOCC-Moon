--Raia, Lifeweaver's Inspiration
--Raia, Ispirazione della Vitatessitrice
--Scripted by: XGlitchy30

local s,id,o=GetID()
function s.initial_effect(c)
	--[[If this card is Normal Summoned, or Special Summoned by the effect of a "Lifeweaver" card: You can target 1 card on the field;
	banish it, but you cannot Special Summon monsters from your Extra Deck for the rest of this turn, except Time Leap Monsters.]]
	...
	--[[If this card is banished: You can activate this effect; Special Summon 1 of your banished "Lifeweaver" monsters during your next Standby Phase.]]
...
function s.delayop(e,tp,eg,ep,ev,re,r,rp)
	...
	local rct = Duel.IsStandbyPhase(tp) and 2 or 1
	...
	e1:SetReset(RESET_PHASE|PHASE_STANDBY|RESET_TURN_SELF,rct)
	Duel.RegisterEffect(e1,tp)
end
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return Duel.GetTurnPlayer()==tp and (sp_label==1 or turn~=Duel.GetTurnCount()) and Duel.GetMZoneCount(tp)>0 and Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_REMOVED,0,1,nil,e,tp)
end
