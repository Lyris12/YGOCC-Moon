--Olea Iridica, Lifeweaver's Joy
--Olea Iridica, Gioia della Vitatessitrice
...
function s.initial_effect(c)
	...
	banish 1 face-up card on the field during the next Standby Phase.]]
	...
	c:RegisterEffect(e1)
	--[[When your opponent activates a monster effect (Quick Effect): You can return this card to the Extra Deck, and if you do, negate that effect, and if you do that, banish that card.]]
...
function s.TLmaterial(c)
	return c:IsAttributeRace(ATTRIBUTE_WIND,RACE_PSYCHIC)
end
...
function s.rmcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (sp_label==1 or turn~=Duel.GetTurnCount()) and Duel.IsExistingMatchingCard(s.rmfilter,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil)
end
