...
function cm.spfilter(c,e,tp)
	return c:IsSetCard(0x1406) and ((c:IsFaceup() and c:IsLocation(LOCATION_DECK)) or c:IsLocation(LOCATION_HAND)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEDOWN_DEFENSE) and not c:IsCode(m)
end
