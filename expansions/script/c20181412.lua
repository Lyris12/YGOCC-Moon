...
function s.initial_effect(c)
	...
	e1:SetCondition(function() return c:GetFlagEffect(706)>0 end)
	...
	e2:SetCondition(function() return c:GetFlagEffect(706)>0 end)
	...
	c:RegisterEffect(e3)
	aux.EnablePandemoniumAttribute(c,e3,true,TYPE_EFFECT+TYPE_FUSION)
