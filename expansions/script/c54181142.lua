...
function cid.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then
		...
		return Duel.IsExistingMatchingCard(cid.cfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,3,nil)
	end
	...
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	Duel.Remove(Duel.SelectMatchingCard(tp,cid.cfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,3-#g,3-#g,nil),POS_FACEUP,REASON_COST)
end
