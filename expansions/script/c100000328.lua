...
function s.initial_effect(c)
	...
	--[[If a card or effect is activated (except during the Damage Step): You can place 1 "Monolit by the Moon" from your Deck in your Pendulum Zone,
	and if you do, during the Standby Phase of the next turn, apply this effect.
