...
function s.initial_effect(c)
	...
	e1:SetCondition(function(eff,tp,eg,ep,ev,re,r,rp) return eg:IsExists(Card.IsFacedown,1,nil) and Duel.IsExistingMatchingCard(aux.AND(Card.IsFaceup,Card.IsSetCard),tp,LOCATION_MZONE,0,1,nil,0xae6) end)
	e1:SetTarget(s.drtg)
