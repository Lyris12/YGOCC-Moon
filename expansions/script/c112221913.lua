...
function cid.initial_effect(c)
	...
	qe1:SetCondition(function(e) return cid.con(e) and e:GetHandler():IsHasEffect(id+101) end)
	...
	qe2:SetCondition(function(e) return cid.con(e) and e:GetHandler():IsHasEffect(id+101) end)
	...
	qe3:SetCondition(function(e) return cid.con(e) and e:GetHandler():IsHasEffect(id+101) end)
