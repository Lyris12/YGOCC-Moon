--Macro Cosmos
--Reason for custom script: Card mentions "Helios - The Primordial Sun"
--Date of last referenced TCG/OCG version (dd/mm/yyyy): 13/04/2024
function c30241314.initial_effect(c)
	aux.AddCodeList(c,CARD_HELIOS_THE_PRIMORDIAL_SUN)
	--Activate
