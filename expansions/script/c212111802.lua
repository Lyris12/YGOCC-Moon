...
function s.initial_effect(c)
	...
	local q1=c:DriveEffect(2,nil,CATEGORY_COIN,nil,nil,nil,s.icon,nil,s.deutg,s.deuop):Clone()
	q1:SetType(EFFECT_TYPE_QUICK_O)
	q1:SetCode(EVENT_FREE_CHAIN)
	q1:SetCondition(s.qcon)
	c:RegisterEffect(q1)
	local q2=c:DriveEffect(-8,nil,CATEGORY_DISABLE,nil,EFFECT_FLAG_CARD_TARGET,nil,aux.AND(s.discon,s.icon),nil,s.distg,s.disop):Clone()
