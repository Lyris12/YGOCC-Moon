...
function cid.initial_effect(c)
	...
	qe:SetCondition(function(e,tp) return Duel.IsPlayerAffectedByEffect(tp,id+113) end)
	local e5=e4:Clone()
...
function cid.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.IsPlayerAffectedByEffect(tp,id+13) then Duel.SetChainLimit(function(e,rpr,p) return rpr==p end) end
end
