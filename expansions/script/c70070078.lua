...
function cid.initial_effect(c)
	...
	e2:SetCondition(function(e) local tp=e:GetHandlerPlayer() return not Duel.IsExistingMatchingCard(aux.OR(Card.IsFacedown,aux.NOT(Card.IsSetCard)),tp,LOCATION_MZONE,0,1,nil,0x777) and Duel.GetTurnPlayer()==tp end)
