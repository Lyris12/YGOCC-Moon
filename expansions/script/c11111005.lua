...
function c11111005.dfilter(c)
	return c:IsFaceup() and c:IsCanTurnSet()
end
function c11111005.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c11111005.dfilter(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c11111005.dfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
