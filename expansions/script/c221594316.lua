...
function s.initial_effect(c)
	...
	e3:SetValue(function(e) return Duel.GetMatchingGroupCount(s.atkfilter,e:GetHandlerPlayer(),LOCATION_REMOVED,0,nil)*100 end)
	c:RegisterEffect(e3)
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Remove(Duel.GetMatchingGroup(s.rmfilter,tp,LOCATION_GRAVE,LOCATION_GRAVE,nil),POS_FACEUP,REASON_EFFECT)
end
