...
function s.cfilter(c,...)
	return c:IsSetCard(ARCHE_DREAD_BASTILLE) and c:IsType(TYPE_MONSTER) and c:IsAbleToGrave() and not c:IsCode(...)
end
...
function s.sfilter(c)
	return c:IsCode(CARD_DREAD_BASTILLE_OVERTURE) and c:IsAbleToHand()
end
