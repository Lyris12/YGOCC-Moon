...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	local loc=LOCATION_HAND+(e:GetHandler():IsHasEffect(id+10) and LOCATION_DECK or 0)
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SpecialSummon(Duel.SelectMatchingCard(tp,s.filter,tp,LOCATION_HAND+(e:GetHandler():IsHasEffect(id+10) and LOCATION_DECK or 0),0,1,1,nil,e,tp),0,tp,tp,false,false,POS_FACEUP)>0 then
		Duel.BreakEffect()
