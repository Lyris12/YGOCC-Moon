...
function cid.filter(c)
	return c:IsSetCard(0xa5f) and c:IsType(TYPE_MONSTER) and c:IsAbleToHand() and not c:IsCode(id)
end
...
function cid.op(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.SpecialSummon(Duel.SelectMatchingCard(tp,cid.sfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp),0,tp,tp,false,false,POS_FACEUP)
end
