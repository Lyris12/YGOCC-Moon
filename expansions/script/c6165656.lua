...
function c6165656.initial_effect(c)
	...
	if not c6165656.rum_limit then
		c6165656.rum_limit=aux.CreateRUMLimitFunction(c6165656.rumlimit)
	end
...
function c6165656.rumlimit(mc,e,tp,c)
	return mc:IsCode(48995978)
end
