...
function s.scfilter(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x4b0) and c:HasLevel() and c:IsLevelBelow(4)
...
function s.scop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.scfilter,tp,LOCATION_REMOVED,0,1,1,nil,e,tp)
	if #g>0 then
