...
function c100001184.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-3
		and Duel.CheckReleaseGroup(REASON_COST,tp,c100001184.spfilter,1,nil,100001183)
		and Duel.CheckReleaseGroup(REASON_COST,tp,c100001184.spfilter,1,nil,100001185)
		and Duel.CheckReleaseGroup(REASON_COST,tp,c100001184.spfilter,1,nil,100001186)
end
function c100001184.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g1=Duel.SelectReleaseGroup(REASON_COST,tp,c100001184.spfilter,1,1,nil,100001183)
	local g2=Duel.SelectReleaseGroup(REASON_COST,tp,c100001184.spfilter,1,1,nil,100001185)
	local g3=Duel.SelectReleaseGroup(REASON_COST,tp,c100001184.spfilter,1,1,nil,100001186)
	g1:Merge(g2)
	g1:Merge(g3)
