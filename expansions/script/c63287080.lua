...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--ATK
	c:UpdateATKField(200,nil,LOCATION_MZONE,0,aux.TargetBoolFunction(Card.IsRace,RACE_PSYCHIC+RACE_WINGEDBEAST))
	--splimit
...
function s.thfilter(c)
	return c:IsMonster() and c:IsRace(RACE_PSYCHIC+RACE_WINGEDBEAST) and c:IsAbleToHand()
end
...
function s.splimit(e,c)
	return not c:IsRace(RACE_PSYCHIC+RACE_WINGEDBEAST)
end
...
function s.tdfilter(c)
	return c:IsMonster() and c:IsRace(RACE_PSYCHIC+RACE_WINGEDBEAST) and c:IsAbleToDeck()
end
