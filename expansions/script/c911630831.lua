...
function cid.initial_effect(c)
	...
	e2:SetCondition(function(e,tp) return Duel.GetTurnPlayer()==tp and Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_GRAVE,0,1,nil,911630827) and aux.exccon(e) end)
