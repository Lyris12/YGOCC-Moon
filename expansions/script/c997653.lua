...
function s.filter(c,e,tp)
	return not c:IsAttribute(ATTRIBUTE_WIND) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsSetCard(0x12D9)
end
...
function s.thcfilter(c,tp)
	return c:IsPreviousControler(tp) and c:IsAttribute(ATTRIBUTE_EARTH)
end
