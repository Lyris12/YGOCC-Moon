...
function s.costfilter(c,tp)
	return c:IsSetCard(0x89f) and c:IsType(TYPE_MONSTER) and c:IsLevelAbove(1) and c:IsDiscardable() and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_MZONE+LOCATION_HAND,0,1,c,c:GetLevel())
end
...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(s.filter,tp,LOCATION_MZONE+LOCATION_HAND,0,nil,e:GetLabel())
