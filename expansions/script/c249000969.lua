...
function c249000969.cfilter(c)
	return c:IsAbleToRemoveAsCost() and c:IsRace(RACE_CYBERSE) and c:IsCode(645087,11674673,11738489,14505685,24731391,25200959,36033786,42717221,46104361,52698008,56337500,60279710,63533837,86784733,89238128,91269402,249000967,249000968,269000024)
end
