...
function c11000521.initial_effect(c)
	...
	e4:SetCountLimit(1)
	e4:SetCondition(c32339440.thcon1)
	e4:SetTarget(c32339440.thtg1)
	e4:SetOperation(c32339440.thop1)
	c:RegisterEffect(e4)
	--add
...
function c11000521.thtg1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c11000521.thfilter1,tp,LOCATION_GRAVE,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_GRAVE)
end
function c11000521.thop1(e,tp,eg,ep,ev,re,r,rp)
	if not e:GetHandler():IsRelateToEffect(e) then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c11000521.thfilter1,tp,LOCATION_GRAVE,0,1,1,nil)
