...
function cid.initial_effect(c)
	...
	aux.AddBigbangProc(c,aux.AND(aux.FilterEqualFunction(Card.GetVibe,0)),aux.FilterBoolFunction(Card.IsSetCard,0x37e),1,aux.NOT(aux.FilterEqualFunction(Card.GetVibe,0)),2)
	c:EnableReviveLimit()
	--cannot spsummon
