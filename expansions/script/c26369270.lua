...
function s.repfilter(c,tp)
	return c:IsFaceup() and c:IsRace(RACE_PSYCHO) and c:IsType(TYPE_PANDEMONIUM) and c:IsLocation(LOCATION_MZONE) and c:IsControler(tp) and c:GetDestination()==LOCATION_REMOVED
