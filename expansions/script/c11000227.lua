...
function c11000227.concost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(REASON_COST,tp,c11000227.cfilter,1,nil,tp) end
	local sg=Duel.SelectReleaseGroup(REASON_COST,tp,c11000227.cfilter,1,1,nil,tp)
