...
function s.initial_effect(c)
	...
	e7:SetValue(function(e,c) return -Duel.GetMatchingGroupCount(s.filter,tp,LOCATION_REMOVED,0,nil)*200 end)
	c:RegisterEffect(e7)
	local e6=e7:Clone()
	...
	e4:SetTarget(s.datktg)
	e4:SetOperation(s.datcop)
	c:RegisterEffect(e4)
...
function s.datktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
